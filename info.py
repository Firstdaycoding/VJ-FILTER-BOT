...
BOT_TOKEN = environ.get('BOT_TOKEN', "7152596572:AAHP29pVJCNBGl6Mp0W6M0V8nnVSXNOFAsY")
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '771619396 6001922744').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002031531549').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://chomu:chomu@cluster0.cqlbqnn.mongodb.net/?retryWrites=true&w=majority")
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/PREMIUMMOVIEWORLD')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/mahi4999')
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("URL", "https://chomubot-7839465eb090.herokuapp.com/")
